...
\section{Results}
    ...
    % trending towards same efficiency in both scenarios, but more effort in city scenario
    % also talk about how despite the second object in the city scenario being more difficult, results were still valuable.
