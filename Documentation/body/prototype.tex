...
\section{Networking}
    ...
    \subsection{User Manager and Table Manager} \label{sec:user_table_manager}
    ...
    % Events
        ...
        % when a table's position and rotation is updated (table network, received by all)
            % if client is in table, move to new position in seat
            % update replico controller
        % when table is spawned (table network)
            % create table replica
        % when table despawns (table network)
            % destroy table replica
        % when table seat is updated (table network, received by all)
            % update table replica
