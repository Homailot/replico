...
\thesisdate{July 15, 2024}

%% Comment next line copyright text if not used
%%\copyrightnotice{Name of the Author, 2008}

\supervisor{Supervisor}{Prof.\ Daniel Filipe Martins Tavares Mendes}

%% Uncomment next line if necessary
\supervisor{Second Supervisor}{Prof.\ Rui Pedro Amaral Rodrigues}

%% Uncomment committee stuff in the final version
\committeetext{Approved in oral examination by the committee:}
\committeemember{President}{Prof.\ António Augusto de Sousa}
\committeemember{Supervisor}{Prof.\ Daniel Filipe Martins Tavares Mendes}
\committeemember{Examiner}{Prof.\ Bernardo José Santos Marques}
